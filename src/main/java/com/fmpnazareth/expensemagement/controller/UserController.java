package com.fmpnazareth.expensemagement.controller;
...
import com.fmpnazareth.expensemagement.response.Response;
...
public class UserController {
	...
	private void validateCreateUser(User user, BindingResult result) {
		if (user.getCodUser() == null) {
			result.addError(new ObjectError("User", "Code user no information"));
			return;
		}
	}
